 ...
 */
export function encodeAnchor(anchor: AsideAnchor): string {
 ...
 */
export function parseAnchor(text: string): AsideAnchor | undefined {
...
export function isAsideAnchor(value: unknown): value is AsideAnchor {
...
export function anchorSummary(exact: string, max = 60): string {
 ...
 */
export function anchorKey(anchor: AsideAnchor): string {
  return [
    anchor.messageId ?? '',
    anchor.exact,
    anchor.prefix,
 ...
 */
export function anchorMessage(anchor: AsideAnchor): string {
